...
//
//        for(int i = 0, nextPos = 0; i < FIXED_BASE_TABLE.length; i += 3, nextPos++) {
//            long coordinateX = FIXED_BASE_TABLE[i], coordinateY = FIXED_BASE_TABLE[i+1], coordinateT = FIXED_BASE_TABLE[i+2];
//
//            parsedArray[nextPos] = new PreComputedExtendedPoint(
//                    Params.convertBigIntegerToF2Element(BigInteger.valueOf(coordinateX)),   // X
//                    Params.convertBigIntegerToF2Element(BigInteger.valueOf(coordinateY)),   // Y
//                    new F2Element(BigInteger.ONE, BigInteger.ZERO),                         // Z
//                    Params.convertBigIntegerToF2Element(BigInteger.valueOf(coordinateT))    // T
//            );
//        }
//
//        return parsedArray;
