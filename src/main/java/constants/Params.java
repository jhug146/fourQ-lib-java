...
/**
 * Mathematical constants and parameters for the FourQ elliptic curve cryptographic implementation.
 * <p>
 * This class contains all the cryptographic constants used throughout the FourQ library including:
 * - Field parameters for the Mersenne prime field GF(2^127-1)
 * - Curve parameters and generator point coordinates
 * - Montgomery arithmetic constants for efficient modular operations
...
public final class Params {
    ...
    /** Hexadecimal radix for parsing hex string constants */
